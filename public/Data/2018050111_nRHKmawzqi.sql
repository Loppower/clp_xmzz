...
INSERT INTO `clt_article` VALUES (21,5,1,'admin','CLTPHP4.5发布','color:rgb(0, 153, 102);font-weight:bold;','','CLTPHP4.5发布','CLTPHP4.5发布','<p>1.更新权限功能</p><p>2.增加微信关注回复和默认回复</p><p>3.增加后台页面过度效果</p><p>4.后台部分功能代码优化</p>','0',2,1,0,'',0,0,355,1502067980,1502422491,'CLTPHP','http://www.cltphp.com/');
...
CREATE TABLE `clt_auth_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 COMMENT='权限节点';
...
INSERT INTO `clt_auth_rule` VALUES (15,'Auth/adminList','权限管理',1,1,0,'icon-lifebuoy','',0,1,1446535750,1,0);
...
INSERT INTO `clt_auth_rule` VALUES (31,'Link/index','友情链接',1,1,0,'','',28,2,1447232183,0,0);
...
INSERT INTO `clt_auth_rule` VALUES (163,'Users/edit','编辑',1,1,0,'','',29,2,1461550835,1,0);
...
INSERT INTO `clt_auth_rule` VALUES (274,'Wheat/index','小麦管理',1,1,1,'icon-tree','',0,1,1521953795,0,1);
...
INSERT INTO `clt_auth_rule` VALUES (279,'Strategy/template_index','小麦策略管理',1,1,1,'icon-book','',0,2,1524582937,0,1);
INSERT INTO `clt_auth_rule` VALUES (282,'Scheme/index','方案管理',1,1,1,'icon-list','',0,2,1524672861,0,1);
INSERT INTO `clt_auth_rule` VALUES (281,'Strategy/bch_index','病虫管理策略',1,1,1,'','',279,1,1524583106,0,1);
INSERT INTO `clt_auth_rule` VALUES (283,'Scheme/index','方案列表',1,1,1,'','',282,1,1524737469,0,1);
INSERT INTO `clt_auth_rule` VALUES (288,'Strategy/water_index','水分管理策略',1,1,1,'','',279,3,1524845782,0,1);
INSERT INTO `clt_auth_rule` VALUES (287,'Strategy/manure_index','施肥管理策略',1,1,1,'','',279,2,1524845567,0,1);
--
-- 表的结构 `clt_category`
-- 
...
INSERT INTO `clt_config` VALUES (62,'smtp_user','123@qq.com','smtp','0');
INSERT INTO `clt_config` VALUES (63,'smtp_pwd','123232321','smtp','0');
INSERT INTO `clt_config` VALUES (64,'regis_smtp_enable','1','smtp','0');
INSERT INTO `clt_config` VALUES (65,'test_eamil','456@qq.com','smtp','0');
...
--
INSERT INTO `clt_system` VALUES (1,'小麦种植系统','http://www.xmzz.com/','XMZZ','小麦种植管理系统,php','11111','11111','2222','3333','44444','55555','/uploads/20180426/aa8018dbb78f851ccca2e19da42a5a3b.png');
--
-- 表的结构 `clt_team`
-- 
...
INSERT INTO `clt_users` VALUES (2600,'1060494425@qq.com','25d55ad283aa400af464c76d713c07ad','0',0,0,1512540142,0,'','','',0,'','0','0','0',0,0,0,1,'ziyou',1,1,'584e370195aaeaa701fb4708bed2e28c','','hide');
--
-- 表的结构 `clt_wheat`
-- 
DROP TABLE IF EXISTS `clt_wheat`;
CREATE TABLE `clt_wheat` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL COMMENT '小麦名称',
  `img_url` varchar(200) DEFAULT NULL COMMENT '小麦图片URL',
  `type_id` tinyint(4) DEFAULT NULL COMMENT '所属栏目ID',
  `sort` int(5) NOT NULL DEFAULT '50' COMMENT '排序',
  `update_time` int(11) DEFAULT NULL,
  `create_time` int(11) NOT NULL COMMENT '添加时间',
  `is_lock` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1禁用0启用',
  `delete` int(1) NOT NULL DEFAULT '0' COMMENT '0未删除/1删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;

-- 
-- 导出`clt_wheat`表中的数据 `clt_wheat`
--
INSERT INTO `clt_wheat` VALUES (10,'小麦1','http://img.redocn.com/sheying/20160601/dengdaishougedexiaomai_6415813.jpg',16,1,0,1495183645,1,0);
--
-- 表的结构 `clt_wheat_bch`
-- 
...
--
-- 表的结构 `clt_wheat_scheme`
-- 
DROP TABLE IF EXISTS `clt_wheat_scheme`;
CREATE TABLE `clt_wheat_scheme` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `wheat_id` int(5) NOT NULL COMMENT '小麦',
  `bch_id` int(5) DEFAULT NULL COMMENT '病虫害',
  `water_id` int(5) DEFAULT NULL COMMENT '水份',
  `manure_id` int(5) DEFAULT NULL COMMENT '肥料',
  `abstract` varchar(100) NOT NULL COMMENT '摘要',
  `create_time` int(11) NOT NULL COMMENT '添加时间',
  `update_time` int(11) DEFAULT NULL,
...
-- 
-- 导出`clt_wheat_scheme`表中的数据 `clt_wheat_scheme`
--
INSERT INTO `clt_wheat_scheme` VALUES (1,10,2,6,5,'',1524752198,1524752741,0,0);
INSERT INTO `clt_wheat_scheme` VALUES (2,10,2,6,5,'小麦1春虫2一亩地农家肥',1524994712,1524994712,0,0);
--
...
--
INSERT INTO `clt_wheat_strategy` VALUES (1,'虫1','从前有一种虫害','bch',11111,0,1,1);
...
INSERT INTO `clt_wheat_strategy` VALUES (4,'肥料','<p>肥料</p>','manure',1524985149,1524985149,0,1);
INSERT INTO `clt_wheat_strategy` VALUES (5,'农家肥','<p>施肥就要农家肥</p>','manure',1524985421,1524985421,0,0);
INSERT INTO `clt_wheat_strategy` VALUES (6,'一亩地','<p>一亩地要放一吨水</p>','water',1524985823,1524985823,0,0);
--
-- 表的结构 `clt_wheat_type`
-- 
DROP TABLE IF EXISTS `clt_wheat_type`;
CREATE TABLE `clt_wheat_type` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `type_name` varchar(50) NOT NULL COMMENT '小麦名称',
...
-- 
-- 导出`clt_wheat_type`表中的数据 `clt_wheat_type`
--
INSERT INTO `clt_wheat_type` VALUES (16,'春',1,111111,0,0,1,0);
--
-- 表的结构 `clt_wheat_water`
-- 
DROP TABLE IF EXISTS `clt_wheat_water`;
CREATE TABLE `clt_wheat_water` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL COMMENT '方案名称',
  `sort` int(5) DEFAULT '50' COMMENT '排序',
  `addtime` int(11) NOT NULL COMMENT '添加时间',
...
-- 
-- 导出`clt_wheat_water`表中的数据 `clt_wheat_water`
--
INSERT INTO `clt_wheat_water` VALUES (10,'CLTPHP',1,1495183645,1,0,0,'0');
INSERT INTO `clt_wheat_water` VALUES (8,'CLTPHP内容管理系统',2,1484791374,1,0,0,'0');
INSERT INTO `clt_wheat_water` VALUES (11,'CLTPHP动态',3,1499765975,1,0,0,'0');
INSERT INTO `clt_wheat_water` VALUES (12,'关于我们',4,1499766009,1,0,0,'0');
INSERT INTO `clt_wheat_water` VALUES (13,'CLTPHP相关知识',5,1499766031,1,0,0,'0');
INSERT INTO `clt_wheat_water` VALUES (15,'有你有我影视',6,1501030917,1,0,0,'0');
--
-- 表的结构 `clt_wx_auth`
-- 
